...
import static pharmacyjava.Splash.progress;
   ...
   pbThread t1;
    ...
    /*public static void main()
    {
        ...
        try{
            ...
            {
                Thread.sleep(100);
                Splash.lbllord.setText(Integer.toString(x)+"%");
                Splash.progress.setValue(x);
    ...
    class pbThread extends Thread
    {
        ...
        public void run()
        {
            ...
            for(int i=min;i<max;i++)
            {
                ...
                {
                    Logger.getLogger(progress.getName()).log(Level.SEVERE,null,e);
                }
            }
